algoritmos=( "python3 ../algoritmos/IV.4\ Parallel\ Block/src/python/IV.4-Parallel-Block.py"
	     ...
	     "gcc -o  ../algoritmos/IV.4\ Parallel\ Block/src/c/Parallel-Block ../algoritmos/IV.4\ Parallel\ Block/src/c/IV.4-Parallel-Block.c && ./../algoritmos/IV.4\ Parallel\ Block/src/c/Parallel-Block"
